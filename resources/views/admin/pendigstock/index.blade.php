...
@section('content')
@section('pageTitle', 'Pending Stock Items')
<style type="text/css">
            ...
            <div class="collapse" id="collapseExample">
                    <div class="card card-info card-outline displaybl">
                        <div class="card-body" style="padding: 10px 15px;">
                            <form action="{{ route('admin.pendingstock.export') }}" method="POST">
                                @csrf
                                <div class="col-lg-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4 ml-3" style="padding-left: 0px;">
                                        ...
                                        <a href="{{ url('admin/pendingstock') }}" class="btn btn-danger btn-sm ml-1"
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $("#stocks").DataTable({
                ...
                // ],
                ajax: {
                    'url': "{{ route('admin.pendingstock.getall') }}",
                    'type': 'POST',
                    'data': function (d) {
                        d._token = "{{ csrf_token() }}";
        ...
        $('body').on('click', '.openaddmodallog', function () {
           ...
           $.ajax({
               url: "{{ route('admin.pendingstock.addlog')}}",
               type: 'POST',
               headers: {
                   'X-CSRF-TOKEN': '{{ csrf_token() }}'
               },
        ...
        $('body').on('click', '.history_log_show', function () {
               ...
               $.ajax({
                   url: "{{ route('admin.pendingstock.getmodalhistory')}}",
                   type: 'POST',
                   headers: {
                       'X-CSRF-TOKEN': '{{ csrf_token() }}'
                   },
